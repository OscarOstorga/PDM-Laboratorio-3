...
fun InsertDataComponent(modifier: Modifier = Modifier) {
    ...
    Column(modifier = modifier.fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Button(modifier = Modifier.padding(bottom = 5.dp), onClick = {
            /*Agrega objeto a base de datos*/
            var myList: MutableList<ObjectClass> = viewModel.getData()
            myList.add( ObjectClass( textFieldPropertyOne.value, textFieldPropertyTwo.value) )
